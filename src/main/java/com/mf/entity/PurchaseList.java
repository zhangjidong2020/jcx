 ...
 */
@Entity
//@Table(name="t_purchaseList") 2019-05-11
...
public class PurchaseList {
	...
	@Transient
	private Date bPurchaseDate; // 起始日期 搜索用到
	
	@Transient
	private Date ePurchaseDate; // 结束日期 搜索用到
	...
	public String toString() {
		return "PurchaseList [id=" + id + ", purchaseNumber=" + purchaseNumber + ", supplier=" + supplier
				+ ", purchaseDate=" + purchaseDate + ", amountPayable=" + amountPayable + ", amountPaid=" + amountPaid
